...
export default {
  general: {
    ...
    aboutTheAppText:
      "Poštovani korisniče,<br /> Karta rasta je aplikacija namenjena praćenju rasta i pravovremenom prepoznavanju problema koji mogu da nastanu tokom rasta i razvoja deteta. Ova aplikacija ne zamenjuje redovna merenja tokom sistematskih pregleda u Domu Zdravlja. Za sve dodatne informacije obratite se Vašem izabranom lekaru!",
